...
CREATE VIEW [etl].[vw_Load_TM_DimItem] AS (
	...
	SELECT  
		...
		, dSeason.SeasonName Season
		, dSeason.ETL__SSID_TM_season_Id TM_season_id
	...
	LEFT OUTER JOIN etl.vw_DimSeason dSeason (NOLOCK) ON i.Season_id = dSeason.ETL__SSID_TM_season_Id
