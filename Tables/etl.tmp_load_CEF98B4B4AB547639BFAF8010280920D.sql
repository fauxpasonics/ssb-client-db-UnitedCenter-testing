CREATE TABLE [etl].[tmp_load_CEF98B4B4AB547639BFAF8010280920D]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_CEF98B4B4AB547639BFAF8010280920D_ss] ON [etl].[tmp_load_CEF98B4B4AB547639BFAF8010280920D] ([SourceSystem], [SSID])
GO
