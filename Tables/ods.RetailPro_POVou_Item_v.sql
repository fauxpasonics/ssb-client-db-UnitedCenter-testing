CREATE TABLE [ods].[RetailPro_POVou_Item_v]
(
...
[TAX_AMT_EXCL] [decimal] (18, 6) NULL,
[TAX_AMT_INCL] [decimal] (18, 6) NULL,
[SHIPPING_AMT] [decimal] (18, 6) NULL,
[DISC_AMT] [decimal] (18, 6) NULL,
[CARTON_NO] [nvarchar] (30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[CARTON_STATUS] [nvarchar] (10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[CUST_FLD] [nvarchar] (10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[SCAN_UPC] [bigint] NULL,
[SERIAL_NO] [nvarchar] (30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[LOT_NUMBER] [nvarchar] (30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[SPREAD_FEE_AMT] [decimal] (18, 6) NULL,
[ALT_UPC] [bigint] NULL,
...
[FROM_ASN] [int] NULL,
[SUBLOC_ID] [int] NULL,
[SUBLOC_CODE] [nvarchar] (30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [ods].[RetailPro_POVou_Item_v] ADD CONSTRAINT [PK_ods__RetailPro_POVou_Item_v] PRIMARY KEY NONCLUSTERED  ([ETL__ID])
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__RetailPro_POVou_Item_v] ON [ods].[RetailPro_POVou_Item_v]
GO
CREATE NONCLUSTERED INDEX [IX_ETL__UpdatedDate] ON [ods].[RetailPro_POVou_Item_v] ([ETL__UpdatedDate] DESC)
GO
