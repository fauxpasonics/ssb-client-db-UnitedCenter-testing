...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailS__Creat__3A0D7D32] DEFAULT (getdate()),
[CreatedBy] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[UpdatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailS__Updat__3B01A16B] DEFAULT (getdate()),
