...
GO
ALTER TABLE [dbo].[FactAvailSeats_V2] ADD CONSTRAINT [PK_dbo__FactAvailSeats_V2] PRIMARY KEY CLUSTERED  ([FactAvailSeatsId])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__IsDeleted] ON [dbo].[FactAvailSeats_V2] ([ETL__IsDeleted])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__SourceSystem] ON [dbo].[FactAvailSeats_V2] ([ETL__SourceSystem])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__SSID_TM_ods_id] ON [dbo].[FactAvailSeats_V2] ([ETL__SSID_TM_ods_id] DESC)
GO
CREATE NONCLUSTERED INDEX [IX_ETL__UpdatedDate] ON [dbo].[FactAvailSeats_V2] ([ETL__UpdatedDate] DESC)
GO
