...
GO
ALTER TABLE [dbo].[DimLedger_V2] ADD CONSTRAINT [PK_dbo__DimLedger_V2] PRIMARY KEY CLUSTERED  ([DimLedgerId])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__IsDeleted] ON [dbo].[DimLedger_V2] ([ETL__IsDeleted])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__SourceSystem] ON [dbo].[DimLedger_V2] ([ETL__SourceSystem])
GO
CREATE NONCLUSTERED INDEX [IX_KEY_TM] ON [dbo].[DimLedger_V2] ([ETL__SSID_TM_ledger_id])
GO
