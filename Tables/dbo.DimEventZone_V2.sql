...
GO
ALTER TABLE [dbo].[DimEventZone_V2] ADD CONSTRAINT [PK_dbo__DimEventZone_V2] PRIMARY KEY CLUSTERED  ([DimEventZoneId])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__IsDeleted] ON [dbo].[DimEventZone_V2] ([ETL__IsDeleted])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__SourceSystem] ON [dbo].[DimEventZone_V2] ([ETL__SourceSystem])
GO
