...
[SeasonActiveStatus] [nvarchar] (2) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [dbo].[DimSeasonHeader_V2] ADD CONSTRAINT [chk_dbo__DimSeasonHeader_V2_SeasonActiveStatus] CHECK (([SeasonActiveStatus]='FY' OR [SeasonActiveStatus]='PY' OR [SeasonActiveStatus]='CY'))
GO
