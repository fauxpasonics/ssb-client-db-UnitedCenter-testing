CREATE TABLE [stg].[FILE__SSB_QSTTrxeventphysicalsalesexport_20180119]
(
...
GO
ALTER TABLE [stg].[FILE__SSB_QSTTrxeventphysicalsalesexport_20180119] ADD CONSTRAINT [PK__FILE__SS__C4EA2445A5B78244] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
