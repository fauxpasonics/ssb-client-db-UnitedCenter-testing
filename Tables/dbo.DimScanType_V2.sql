...
GO
ALTER TABLE [dbo].[DimScanType_V2] ADD CONSTRAINT [PK_dbo__DimScanType_V2] PRIMARY KEY CLUSTERED  ([DimScanTypeId])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__IsDeleted] ON [dbo].[DimScanType_V2] ([ETL__IsDeleted])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__SourceSystem] ON [dbo].[DimScanType_V2] ([ETL__SourceSystem])
GO
CREATE NONCLUSTERED INDEX [IX_KEY_TM] ON [dbo].[DimScanType_V2] ([ETL__SSID_TM_channel_ind])
GO
