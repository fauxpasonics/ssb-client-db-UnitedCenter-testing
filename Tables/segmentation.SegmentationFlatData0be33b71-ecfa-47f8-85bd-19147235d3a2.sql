CREATE TABLE [segmentation].[SegmentationFlatData0be33b71-ecfa-47f8-85bd-19147235d3a2]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatData0be33b71-ecfa-47f8-85bd-19147235d3a2] ADD CONSTRAINT [pk_SegmentationFlatData0be33b71-ecfa-47f8-85bd-19147235d3a2] PRIMARY KEY NONCLUSTERED  ([id])
GO
